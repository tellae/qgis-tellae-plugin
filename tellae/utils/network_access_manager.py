...
This module is mostly a copy of networkaccessmanager.py from the repository
orstools-qgis-plugin. The original code can be found here:

https://github.com/GIScience/orstools-qgis-plugin/blob/c248e5c99d60c2dbe137298ee0a2f098be48637b/ORStools/common/networkaccessmanager.py#L185

This allowed us to perform async requests (get, put, post, delete) using
the QGIS framework, since our multiple attempts all led to QGIS crashing.
